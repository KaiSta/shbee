...
public class Account {
	 ...
	 * for actions. The total sum of the accounts is recorded on each action
	 * execution.
	 */
	...
	/*
	 * The Service method performs the actual action on the account, and it also
	 * updates the Bank's records. (Bank_Total)
	 */
