...
class BankAccount extends Thread {
	...
	/*
	 * The Action method simulates an action on the account, where the sum of
	 * the action is randomly chosen, and then the bank is requested for a
	 * service.
	 */
	public void Action() {
	...
	/*
	 * The run method performs the actual actions on the account, and it is
	 * supposed to simulate the account owner's actions during the week.
	 */
	public void run() {
		// maximum 500 actions
